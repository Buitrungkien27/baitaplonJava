...
public final class Phien {
    ...
    public Phien(String shiftID, Date startedAt, Account account) {
    ...
    public Phien(String shiftID, Date startedAt, Date endedAt, Account account) throws Exception {
        setAccount(account);
