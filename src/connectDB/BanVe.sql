...
ALTER TABLE [QLBanVe].[dbo].[VeTau]
ADD [maTau] NVARCHAR(50)
DELETE FROM VeTau

ALTER TABLE VeTau
ALTER COLUMN gaDi NVARCHAR(50);
ALTER TABLE VeTau ADD maHoaDon VARCHAR(50);

DELETE FROM ChiTietHoaDon; -- Xóa dữ liệu ở bảng con trước
