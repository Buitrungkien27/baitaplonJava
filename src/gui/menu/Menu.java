...
//        Nếu quản  lí thì cho phép tất cả
    ...
    private void init() {
        ...
        lbl_header.setIcon(new FlatSVGIcon("imgs/logo2.svg"));
    ...
    private void createMenu() {
        String title = Application.nhanVien == null ? " Admin Phát " : String.format(" %s. %s ", Application.nhanVien.getChucVu(), Application.nhanVien.getTenNV());
